...
class HomePageState extends State<HomePage> {
  ...
  showErrorMessage(){
    if(Provider.of<GlobalProvider>(context, listen: false).photoErrorCounter==0){
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                color:
                                    globalData.selectedScenarios.contains(allScenarios[index])
                                        ? MyColors.redColor
                                        : null,
                  ...
                  return GestureDetector(
                    onTap: load
                        ...
                        : () async {
                            if (globalData.selectedScenarios.length == 0) {
                            ...
                            } else if (globalData.selectedScenarios[0].scenarioType !=
                              ...
                              if (file != null) {
                                ...
                                if (result) {
                                  await push(
                                      context: context,
                                      screen: DetectedImageView(key: MyGlobalKeys.detectedImageViewStateKey,
                                          customPaint: _customPaint!, file: file!));
                                } else {
