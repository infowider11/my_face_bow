...
class CameraPreviewWithoutWax extends StatefulWidget {
  final Function( InputImage inputImage) onImage;
  const CameraPreviewWithoutWax({
    required Key key,
    required this.onImage,
  }) : super(key: key);

  @override
  State<CameraPreviewWithoutWax> createState() => CameraPreviewWithoutWaxState();
}

class CameraPreviewWithoutWaxState extends State<CameraPreviewWithoutWax>
